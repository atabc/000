...
export default {
   ...
   * Github Issues 配置
   */
  username: 'atabc', // github 用户名
  repository: 'blog', // 文章仓库地址
  token: ['7edcfcfcf6d3b37c5d6f', 'b2c8528813faeb68fd47'], // token 从中间任意位置拆开成两部分，避免 github 代码检测失效

  /**
   * Gitalk 配置，文档详见：https://github.com/gitalk/gitalk
   */
  gitalk: {
    clientID: '1b9eb7b3b795978b5e6f',
    clientSecret: '0b1cb61039e8f6ccf4f5592778835dce6f15beb8',
    repo: 'blogtalk', // 评论仓库地址
    owner: 'atabc',
    admin: ['atabc'],
